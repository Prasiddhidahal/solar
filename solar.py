...
class Comics:
    ...
    def draw(self):
        ...
        glVertex3f(0.0, self.radius, 0.0)
        glVertex3f(-self.radius, -self.radius, 0.0)
        glVertex3f(self.radius, -self.radius, 0.0)
        glEnd()
        glPopMatrix()
...
class SolarSystem:
    def __init__(self):
        self.planets = [
            ...
            Planet("Venus", (0.5, 0.2, 0.0), 0.6, 7.0, 3.0),  
            Planet("Earth", (0.0, 1.0, 0.0), 0.7, 10.0, 2.5),  
    ...
    def update_positions(self):
        ...
        for comics in self.comics:
            comics.update_position()
